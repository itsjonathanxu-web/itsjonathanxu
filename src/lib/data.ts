...
export const projects: Project[] = [
  ...
  // Travel & Destination
  {
    id: "chile-patagonia-lake",
    title: "Patagonia — Glacial Waters",
    category: "Travel & Destination",
    categorySlug: "travel-destination",
    description: "Storm clouds over turquoise glacial waters and snow-capped peaks in Torres del Paine.",
    image: "/chile/DSC08349.jpg",
    type: "photo",
  ...
  {
    id: "chile-patagonia-reflection",
    title: "Patagonia — Mountain Reflection",
    category: "Travel & Destination",
    categorySlug: "travel-destination",
    description: "Snow-capped peaks reflected through the window of a Patagonian ferry crossing.",
    image: "/chile/DSC08354.jpg",
    type: "photo",
    client: "Personal Project",
    year: "2025",
  },
  {
    id: "chile-patagonia-silhouette",
    title: "Patagonia — On the Ridge",
    category: "Travel & Destination",
    categorySlug: "travel-destination",
    description: "A lone figure silhouetted against glaciers and mountain peaks at the edge of the world.",
    image: "/chile/DSC08373.jpg",
    type: "photo",
    client: "Personal Project",
    year: "2025",
  },
  {
    id: "chile-patagonia-glacier",
    title: "Patagonia — Grey Glacier",
    category: "Travel & Destination",
    categorySlug: "travel-destination",
    description: "The vivid blue face of Grey Glacier framed between dark Patagonian rock faces.",
    image: "/chile/DSC08376.jpg",
    type: "photo",
    client: "Personal Project",
    year: "2025",
  },
  {
    id: "chile-patagonia-forest",
    title: "Patagonia — Ghost Forest",
    category: "Travel & Destination",
    categorySlug: "travel-destination",
    description: "Weathered trees standing across a green Patagonian hillside — raw and untouched.",
    image: "/chile/DSC08379.jpg",
    type: "photo",
    client: "Personal Project",
    year: "2025",
  },
  {
    id: "chile-patagonia-dead-trees",
    title: "Patagonia — After the Fire",
    category: "Travel & Destination",
    categorySlug: "travel-destination",
    description: "Skeletal trees reaching toward an overcast sky — Patagonia's stark, beautiful decay.",
    image: "/chile/DSC08383.jpg",
    type: "photo",
    client: "Personal Project",
    year: "2025",
  },
  {
    id: "chile-patagonia-towers",
    title: "Patagonia — Los Cuernos",
    category: "Travel & Destination",
    categorySlug: "travel-destination",
    description: "The dramatic silhouette of the Cuernos del Paine against a pale Patagonian sky.",
    image: "/chile/DSC08389.jpg",
    type: "photo",
    client: "Personal Project",
    year: "2025",
  },
  {
    id: "chile-patagonia-peak",
    title: "Patagonia — Dark Summit",
    category: "Travel & Destination",
    categorySlug: "travel-destination",
    description: "A jagged granite peak rises above the treeline, snow clinging to its dark face.",
    image: "/chile/DSC08390.jpg",
    type: "photo",
    client: "Personal Project",
    year: "2025",
  },
  {
    id: "chile-patagonia-valley",
    title: "Patagonia — Into the Valley",
    category: "Travel & Destination",
    categorySlug: "travel-destination",
    description: "Misty mountain grandeur with a lone tree standing in the foreground of Torres del Paine.",
    image: "/chile/DSC08408.jpg",
    type: "photo",
    client: "Personal Project",
    year: "2025",
  },
